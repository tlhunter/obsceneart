...
<table class="input-table">
	<tr>
		<td class="label-column"><?php echo form_label('Current Password', $old_password['id']); ?></td>
	...
	<tr>
		<td class="label-column"><?php echo form_label('New Password', $new_password['id']); ?></td>
	...
	<tr>
		<td class="label-column"><?php echo form_label('Confirm New Password', $confirm_new_password['id']); ?></td>
